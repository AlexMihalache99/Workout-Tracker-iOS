...
- **AI-generated report summaries** — should improve the generated report by taking into account workout notes, week 10 of strength training blocks being 1RMax week testing, so a drop in volume it's normal, text structure should be cleaner. 
